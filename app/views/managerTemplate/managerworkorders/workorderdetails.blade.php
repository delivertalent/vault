							...
							<form action="#" id="form_sample_2" class="horizontal-form">
								...
								<div class="alert alert-success display-hide doNotPrint">
									...
									<div class="row doNotPrint">
										<div class="col-md-6">
											<div class="form-group">	
												<label class="control-label" for="notes">Note<span class="required">*</span></label>
												...
												<tbody>
													@if($inventories)
														...
														<tr class="odd gradeX">
															...
															<td class="doNotPrint"><a title="Pull" class="btn btn-xs  @if($inventory->inv_delivery_status==3){{"red"}}@else{{"blue"}} @endif btn-editable editPull" data-id="1" id="pull_{{$inventory->id}}" href="javaScript:void(0)"><i class="fa fa-upload"></i></a> &nbsp; <a title="Delivery"  class="btn @if($inventory->inv_delivery_status==4){{"red"}}@else{{"blue"}} @endif btn-xs btn-editable editDeliver" data-id="1" id="deliver_{{$inventory->id}}" href="javaScript:void(0)"><i class="fa fa-truck"></i></a></td>
														</tr>		
														@endforeach
													@endif
...
{{ HTML::script('includes/js/ManagerWorkorderDetails.js') }}
	<script>
