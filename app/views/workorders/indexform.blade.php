						...
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<tbody>
									...
									<tr class="odd gradeX">
										<td><a href="{{ URL::to('/workorder-details/'.$workorder->id)  }}"><b>{{ $workorder->id }}</b></a></td>
										...
										<td>
											...
											<a class="btn btn-xs blue btn-editable edit" data-id="1" id="edit_{{$workorder->id}}" href="{{ URL::to('/workorder-details/'.$workorder->id)  }}"><i class="fa fa-pencil"></i>Edit</a>
										</td>
									</tr>		
									@endforeach
								</tbody>
			...
			<div id="jobform" style="display:none;" class="row">
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div id="modatTitle" class="caption"><i class="fa fa-reorder"></i>Add New Workorder.</div>
							<div class="tools">
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="input-group input-medium date date-picker" data-date-format="yyyy-mm-dd" data-date-start-date="+0d">
														<input type="text" id="wo_delivery_date" name="wo_delivery_date" value="{{date("Y-m-d")}}" class="form-control" style="width:100%" readonly>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="input-group input-medium bootstrap-timepicker">                                       
														<input type="text" id="wo_delivery_time" name="wo_delivery_time" value="{{ date("H:i")}}" class="form-control timepicker-24" style="width:100%" readonly>
														<span class="input-group-btn">
...
{{ HTML::script('includes/js/Workorder.js') }}
{{ HTML::script('includes/js/WorkorderFrom.js') }}
	<script>
