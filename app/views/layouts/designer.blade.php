...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
  ...
  <head>
    ...
    {{ HTML::style('includes/assets/css/pages/portfolio.css') }}
...
<!-- 				<li class="@if($menu=='Customers'){{'active'}} @endif">
	...
	<span class="selected"></span>
				...
				<li class="@if($menu=='Inventories'){{'active'}} @endif">
					<a href="{{ URL::to('/designer-inventories')  }}">
				...
				<li class="@if($menu=='Setting'){{'active'}} @endif">
					...
					<ul class="sub-menu">
						...
						<li class="@if($submenu=='profile'){{'active'}} @endif">
							<a href="{{ URL::to('/profile')  }}">Profile Info</a>
						</li>
						<li class="@if($submenu=='additionalDesigner'){{'active'}} @endif">
							<a href="{{ URL::to('/additional-designer')  }}">Additional User</a>
						</li>
					</ul>
				</li>
			</ul>
	...
	{{ HTML::script('includes/assets/scripts/portfolio.js') }} 
