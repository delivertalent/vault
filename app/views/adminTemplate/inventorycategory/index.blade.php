...
{{ HTML::style('includes/assets/plugins/data-tables/DT_bootstrap.css') }}
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">Inventory Category</h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javaScript:void(0);">Inventory Category</a>
							<i class="fa fa-angle-right"></i>
						</li>
					</ul>
				...
				<!-- BEGIN EXAMPLE TABLE PORTLET-->
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-globe"></i>Manage Inventory Categories</div>
							<div class="actions">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<tbody>
									...
									<tr class="odd gradeX">
										...
										<td>{{ $inventorycategory->invcat_name }}</td>
										<td>
											<!-- <a href ='javaScript:void(0)'  class="btn mini blue" alt="Edit"><i class="fa fa-edit"></i></a> -->
											<a class="btn btn-xs blue btn-editable edit" data-id="1" id="edit_{{$inventorycategory->id}}" href="javaScript:void(0);"><i class="fa fa-pencil"></i>Edit</a>
											<a class="btn btn-xs red btn-removable del" data-id="1" id="del_{{$inventorycategory->id}}" href="javaScript:void(0);"><i class="fa fa-times"></i>Delete</a>
										</td>
									</tr>		
									@endforeach
								</tbody>
			...
			<div id="designerModal" class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 id="modatTitle" class="modal-title">Add Inventory Category</h4>
					</div>
									...
									<div class="row">	
										...
										<div class="row">
											<div class="form-group col-md-11">
												<label class="control-label" for="invcat_name">Inventory Category<span class="required">*</span></label>
												<input id="invcat_name" data-required="1"  name="invcat_name" class="form-control" type="text" placeholder="Inventory Category">
											</div>
										</div>
...
{{ HTML::script('includes/js/adminjs/InventoryCategory.js') }}
	<script>
