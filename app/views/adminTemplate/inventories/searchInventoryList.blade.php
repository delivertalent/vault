	...
	<tbody>
		@if($inventories)
			...
			<tr class="odd gradeX">
				...
				<td id="">{{ wordwrap($inventory->inv_received, 15, "<br />\n") }}</td>
				...
				<td>{{ wordwrap($inventory->inv_quantity, 10, "<br />\n") }}</td>
				<td> <small>
					@if($inventory->inv_delivery_status == 1) {{wordwrap('Not yet received', 10, "<br />\n")}} @endif
					@if($inventory->inv_delivery_status == 2) {{wordwrap('In storage', 10, "<br />\n")}}  @endif
					@if($inventory->inv_delivery_status == 3) {{wordwrap('Pulled/loaded', 10, "<br />\n")}}  @endif
					@if($inventory->inv_delivery_status == 4) {{wordwrap('Delivered', 10, "<br />\n")}}  @endif
				</small>
				</td>
