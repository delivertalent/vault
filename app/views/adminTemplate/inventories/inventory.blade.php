				...
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							...
							<div class="actions">
								<a href="../print-inventory-details/{{$inventories->id}}" class="btn green" type="button">
										...
										<div calss="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input id="inv_qb" data-required="1"  name="inv_qb" value="{{$inventories->inv_qb}}" class="form-control" type="text" placeholder="QB">
												</div>										
											</div>
