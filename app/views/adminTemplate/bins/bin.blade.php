				...
				<!-- BEGIN EXAMPLE TABLE PORTLET-->
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-globe"></i>Manage Bins</div>
							<div class="actions">
								...
								<tbody>
									...
									<tr class="odd gradeX">
										...
										<td>
											...
											<a class="btn btn-xs blue btn-editable edit" data-id="1" id="edit_{{$bin->id}}" href="javaScript:void(0);"><i class="fa fa-pencil"></i>Edit</a>
											<a class="btn btn-xs red btn-removable del" data-id="1" id="del_{{$bin->id}}" href="javaScript:void(0);"><i class="fa fa-times"></i>Delete</a>
										</td>
									</tr>		
									@endforeach
								</tbody>
			...
			<div id="designerModal" class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 id="modatTitle" class="modal-title">Add Bin</h4>
					</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label" for="bin_warehouse">Warehouse<span class="required">*</span></label>
													<select class="form-control" id="bin_warehouse"  name="bin_warehouse">
														@if($warehouses)
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="control-label" for="bin_name">Bin Name<span class="required">*</span></label>
													<input id="bin_name" data-required="1"  name="bin_name" class="form-control" type="text" placeholder="Bin Name">
												</div>
											</div>
										</div>
...
{{ HTML::script('includes/js/adminjs/Bin.js') }}
	<script>
