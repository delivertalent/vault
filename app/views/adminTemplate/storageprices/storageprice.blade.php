						...
						<div class="portlet-body">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">
								...
								<tbody>
									...
									<tr class="odd gradeX">
										<td>{{ $storagePrice->price }}</td>
										<td>
											<!-- <a href ='javaScript:void(0)'  class="btn mini blue" alt="Edit"><i class="fa fa-edit"></i></a> -->
											<a class="btn btn-xs blue btn-editable edit" data-id="1" id="edit_{{$storagePrice->id}}" href="javaScript:void(0);"><i class="fa fa-pencil"></i>Edit</a>
											<a class="btn btn-xs red btn-removable del" data-id="1" id="del_{{$storagePrice->id}}" href="javaScript:void(0);"><i class="fa fa-times"></i>Delete</a>
										</td>
									</tr>		
									@endforeach
								</tbody>
			...
			<div id="designerModal" class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 id="modatTitle" class="modal-title">Add Storage Price</h4>
					</div>
									...
									<div class="form-body">
										...
										<div class="row">
											<div class="form-group col-md-11">
												<label class="control-label" for="price">Storage Price<span class="required">*</span></label>
												<input id="price" data-required="1"  name="price" class="form-control" type="text" placeholder="Price">
											</div>
										</div>
