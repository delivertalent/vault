...
{{ HTML::style('includes/assets/plugins/bootstrap-colorpicker/css/colorpicker.css') }}
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">Closed Work Orders</h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="javaScript:void(0);">Closed Work Orders</a>
							<i class="fa fa-angle-right"></i>
						</li>
					</ul>
				...
				<!-- BEGIN EXAMPLE TABLE PORTLET-->
					<div class="portlet box green">
						<div class="portlet-title">
							<div id="topFlug" class="caption"><i class="fa fa-globe"></i>Closed Work Orders</div>
						</div>
