				...
				<!-- BEGIN EXAMPLE TABLE PORTLET-->
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-globe"></i>Manage Carriers</div>
							<div class="actions">
								...
								<tbody>
									...
									<tr class="odd gradeX">
										...
										<td>
											...
											<a class="btn btn-xs blue btn-editable edit" data-id="1" id="edit_{{$carrier->id}}" href="javaScript:void(0);"><i class="fa fa-pencil"></i>Edit</a>
											<a class="btn btn-xs red btn-removable del" data-id="1" id="del_{{$carrier->id}}" href="javaScript:void(0);"><i class="fa fa-times"></i>Delete</a>
										</td>
									</tr>		
									@endforeach
								</tbody>
			...
			<div id="designerModal" class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 id="modatTitle" class="modal-title">Add Carriers</h4>
					</div>
									...
									<div class="form-body">
										...
										<div class="row">
											<div class="form-group col-md-11">
												<label class="control-label" for="carrier_name">Carriers Name<span class="required">*</span></label>
												<input id="carrier_name" data-required="1"  name="carrier_name" class="form-control" type="text" placeholder="Carriers Name">
											</div>
										</div>
...
{{ HTML::script('includes/js/adminjs/Carrier.js') }}
	<script>
