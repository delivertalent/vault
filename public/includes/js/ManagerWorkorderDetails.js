...
$('.editPull').bind("click", function(event) {
    var el = jQuery("#invLIST");
    App.blockUI(el);
          ...
          $.ajax({
                ...
                success : function(data) {
                    if(data.status=="success"){
                        $("#deliver_"+id).removeClass('red').addClass('blue');
                        $("#pull_"+id).removeClass('blue').addClass('red');
                    }
                }
            });//End of Ajax.
    App.unblockUI(el);
...
$('.editDeliver').bind("click", function(event) {
    var el = jQuery("#invLIST");
    App.blockUI(el);
    ...
    var id=splitID[1];
          ...
          $.ajax({
                ...
                success : function(data) {
                    if(data.status=="success"){
                        $("#pull_"+id).removeClass('red').addClass('blue');
                        $("#deliver_"+id).removeClass('blue').addClass('red');
                    }
                }
            });//End of Ajax.
    App.unblockUI(el);          
