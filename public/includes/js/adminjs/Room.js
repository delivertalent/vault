                          ...
                          $.ajax({
                                ...
                                success : function(data) {
                                    ...
                                    if(data.status == "success"){
                                        ...
                                        $('.form-group').removeClass('has-error').removeClass('has-success');
                                        $('#room_name').val('');
                                        $('.alert-success').html('New Room Successfully Created.');   
                                          success2.show();
                                    ...
                                    if(data.status == "updated"){
                                         ...
                                         var status = '';
                                         oTable.fnUpdate( $('#room_name').val(), parseInt(rowPos), 1);   
...
$('body').on('click','.del',function(){    
    var r=confirm("Do you want to Delete this Room?");
    if (r==true){
