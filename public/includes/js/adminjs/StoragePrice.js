                          ...
                          $.ajax({
                                ...
                                success : function(data) {
                                    ...
                                    if(data.status == "updated"){
                                         ...
                                         var status = '';
                                         oTable.fnUpdate( $('#price').val(), parseInt(rowPos), 0);   
...
$('body').on('click','.del',function(){    
    var r=confirm("Do you want to Delete this Price?");
    if (r==true){
