                          ...
                          $.ajax({
                                ...
                                success : function(data) {
                                    ...
                                    if(data.status == "success"){
                                        ...
                                        $('.form-group').removeClass('has-error').removeClass('has-success');
                                        $('#warehouse_name').val('');
                                        $('.alert-success').html('New Warehouse Successfully Created.');   
                                          success2.show();
                                    ...
                                    if(data.status == "updated"){
                                         ...
                                         var status = '';
                                         oTable.fnUpdate( $('#warehouse_name').val(), parseInt(rowPos), 1);    
...
$('body').on('click','.del',function(){    
    var r=confirm("Do you want to Delete this Warehouse?");
    if (r==true){
    ...
    if(id!=''){
          $.ajax({
                ...
                success : function(data) {
                    ...
                    $('#rowPos').val(aPos);
                    $('#modatTitle').html('Edit Warehouse');
                    $('#responsive').modal('show');     
                }
            });
