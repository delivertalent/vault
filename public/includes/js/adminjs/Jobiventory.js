                               ...
                               //inv_delivery_status inv_warehouse inv_bin inv_binltr inv_note
                                ...
                                success : function(data) {
                                    ...
                                    if(data.status == "success"){
                                        ...
                                        var bb='<a class="btn btn-xs red btn-removable del doNotPrint" data-id="1" id="del_'+data.isertedID+'" href="javaScript:void(0);"><i class="fa fa-times"></i></a>';
...
$('body').on('click','.createQR',function(){   
          $.ajax({
                ...
                data : {
                    ...
                    qr_firm_id : $('#qr_firm_id').val(),
                    qr_inv_description : $('#qr_inv_description').val(),
                    qr_inv_room : $('#qr_inv_room').val(), 
                },
                dataType : 'json',
                success : function(data) {
                    $('#qrContainer').empty();
