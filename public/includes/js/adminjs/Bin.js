                ...
                submitHandler: function (form) {
                    ...
                    App.blockUI(el);
                          $.ajax({
                                ...
                                data : {
                                    id : $('#did').val(),
                                    bin_warehouse : $('#bin_warehouse').val(),
                                ...
                                success : function(data) {
                                    ...
                                    if(data.status == "updated"){
                                         ...
                                         var status = '';
                                         oTable.fnUpdate( $('#bin_name').val(), parseInt(rowPos), 1);   
                                         oTable.fnUpdate( data.warehouses.warehouse_name, parseInt(rowPos), 2);   
    ...
    if(id!=''){
          $.ajax({
                ...
                success : function(data) {
                    ...
                    $('.form-group').removeClass('has-error').removeClass('has-success');
                    $('#did').val(data.id);
                    $('#bin_warehouse').val(data.bin_warehouse);
                    $('#bin_name').val(data.bin_name);
